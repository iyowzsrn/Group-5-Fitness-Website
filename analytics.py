...
def get_analytics():
    ...
    findings = [
    "Workout preferences vary by experience level: Beginners prefer Strength, Intermediate Users favor Yoga, and Advanced Users tend toward Cardio.",

    "BMI alone is not a reliable indicator of body fat, as the relationship between BMI and body fat percentage is negligible.",

    f"The strongest relationship observed was between {strongest_relationship} (r = {strongest_r}), although this correlation remains weak.",

    "Most participants exhibit healthy cardiovascular baselines, with average resting BPM falling within the normal clinical range.",

    "Experience level does not significantly predict body composition.",

    "Gender significantly influences workout preferences."
    ]
